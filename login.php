<?php
session_start();
require_once __DIR__ . '/src/config/config.php'; // adjust path if needed
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Test accounts for development (hardcoded – replace with Supabase Auth later)
    $testAccounts = [
        // IECEP Officers - Super Admin
        'super.admin@iecep-lsc.test' => [
            'password' => 'SuperAdmin123!',
            'role' => 'eb_president',
            'name' => 'IECEP Super Admin',
            'redirect' => '/portal/super-admin/dashboard.php'
        ],
        
        // School Officers - Admin Level
        'test.president@iecep-lsc.test' => [
            'password' => 'TestPresident123!',
            'role' => 'admin',
            'name' => 'School President',
            'redirect' => '/portal/admin/dashboard.php'
        ],
        ...
        // Registration Committee - Admin Level
        ...
        // School Officers - Treasurer/Auditor
        'test.treasurer@iecep-lsc.test' => [
            'password' => 'TestTreasurer123!',
            'role' => 'school_officer',
            'name' => 'School Treasurer',
            'redirect' => '/portal/school-officer/dashboard.php'
        ],
        ...
        'test.member1@iecep-lsc.test' => [
            ...
            'redirect' => '/portal/member/dashboard.php'
        ],
    ...
    if (isset($testAccounts[$email]) && $testAccounts[$email]['password'] === $password) {
        ...
        $redirectUrl = $testAccounts[$email]['redirect'];
        header('Location: ' . $redirectUrl);
        exit;
    } else {
    ...
    <style>
        * {
        ...
        .form-group input:focus {
            ...
            border-color: #0A2F6C;
            background: white;
            box-shadow: 0 0 0 3px rgba(10, 47, 108, 0.1);
        }
        ...
        .btn-back-home:hover {
            ...
            box-shadow: 0 4px 12px rgba(10, 47, 108, 0.2);
        }
        ...
        <div class="login-left">
            <div>
                <div class="logo-container">
                    <img src="/assets/icons/iecep-logo.png" alt="IECEP-LSC Logo">
                </div>
            ...
            <div style="width: 100%;">
                ...
                <div class="schools-row">
                    <img src="/assets/icons/LETRAN.png" alt="Colegio de San Juan de Letrán">
                    <img src="/assets/icons/LSPU-SCC.png" alt="Laguna State Polytechnic University - Santa Cruz Campus">
                    <img src="/assets/icons/LSPU-SPCC.png" alt="Laguna State Polytechnic University - San Pablo City Campus">
                    <img src="/assets/icons/MMCL.webp" alt="Malayan Colleges Laguna">
                    <img src="/assets/icons/PUP-STA ROSA.png" alt="Polytechnic University of the Philippines - Santa Rosa Campus">
                    <img src="/assets/icons/UC-PNC.png" alt="University of Calamba - Polytechnic College">
                    <img src="/assets/icons/UPHSD.png" alt="University of Perpetual Help System - DALTA">
                    <img src="/assets/icons/UPHSL-BINAN.png" alt="University of Perpetual Help System Laguna - Biñán Campus">
                </div>
            </div>
        </div>
