<?php
// sidebar_super_admin.php - Super Admin Sidebar Navigation
$user = get_user_info();
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        <ul class="nav-menu">
            <li>
                <a href="/IECEP-LSC-MEMSYS/public/portal/super-admin/dashboard.php" 
            ...
            <li>
                <a href="/IECEP-LSC-MEMSYS/public/portal/super-admin/affiliations.php" 
                   class="<?php echo $current_page === 'affiliations.php' ? 'active' : ''; ?>">
                    <i class="fas fa-building"></i>
                    <span>Affiliations</span>
                </a>
            </li>
            <li>
                <a href="/IECEP-LSC-MEMSYS/public/portal/super-admin/members.php" 
                   class="<?php echo $current_page === 'members.php' ? 'active' : ''; ?>">
                    <i class="fas fa-users"></i>
                    <span>Members</span>
                </a>
            </li>
            <li>
                <a href="/IECEP-LSC-MEMSYS/public/portal/super-admin/compliance.php" 
            ...
            <li>
                <a href="/IECEP-LSC-MEMSYS/public/portal/super-admin/reports.php" 
            ...
            <li>
                <a href="/IECEP-LSC-MEMSYS/public/portal/super-admin/settings.php" 
        ...
        <div class="nav-section">
            ...
            <ul class="nav-menu">
                <li>
                    <a href="/IECEP-LSC-MEMSYS/public/portal/super-admin/users.php" 
