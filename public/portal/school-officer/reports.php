...
// Role check
$allowed_roles = ['school_officer', 'admin', 'super_admin'];
...
<div class="main-content">
    <div class="dashboard-header">
        <div class="header-content">
            <div>
                ...
                <p class="welcome-message">Generate and manage school reports</p>
            </div>
        </div>
    </div>
    ...
    <div class="content-card">
        ...
        <p>Content will be available soon for school reports management.</p>
