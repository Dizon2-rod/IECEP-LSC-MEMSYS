<?php
// sidebar_officer.php - School Officer Sidebar Navigation
$user = get_user_info();
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        <ul class="nav-menu">
            <li>
                <a href="/IECEP-LSC-MEMSYS/public/portal/officer/dashboard.php" 
            ...
            <li>
                <a href="/IECEP-LSC-MEMSYS/public/portal/officer/members.php" 
            ...
            <li>
                <a href="/IECEP-LSC-MEMSYS/public/portal/officer/attendance.php" 
            ...
            <li>
                <a href="/IECEP-LSC-MEMSYS/public/portal/officer/compliance.php" 
            ...
            <li>
                <a href="/IECEP-LSC-MEMSYS/public/portal/officer/profile.php" 
        ...
        <div class="nav-section">
            ...
            <ul class="nav-menu">
                <li>
                    <a href="/IECEP-LSC-MEMSYS/public/portal/officer/events.php" 
                ...
                <li>
                    <a href="/IECEP-LSC-MEMSYS/public/portal/officer/reports.php" 
