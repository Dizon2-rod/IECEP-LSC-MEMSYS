...
// Role check
$allowed_roles = ['officer', 'admin', 'super_admin'];
...
<div class="main-content">
    <div class="dashboard-header">
        <div class="header-content">
            <div>
                ...
                <p class="welcome-message">Manage organization members and activities</p>
            </div>
        </div>
    </div>
    ...
    <div class="content-card">
        ...
        <p>Content will be available soon for member management.</p>
