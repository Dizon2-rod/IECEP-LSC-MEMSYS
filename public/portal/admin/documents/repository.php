...
<head>
    ...
    <title>Central Document Repository - IECEP-LSC MEMSYS</title>
...
<body>
    <div class="container">
        ...
        <main class="main-content">
            <div class="page-header">
                <div>
                    <h1>Central Document Repository</h1>
                    <p class="text-gray">Manage all chapter documents with blockchain verification</p>
                </div>
                    ...
                    <tbody>
                        ...
                        <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($doc['blockchain_verified']): ?>
                                        <span class="blockchain-badge"><i class="fas fa-link"></i> Verified</span>
                                    <?php else: ?>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        ...
                                        <button onclick="verifyDocument('<?php echo $doc['id']; ?>')" class="btn btn-sm btn-primary" title="Verify">
    ...
    <div class="modal" id="uploadModal">
        <div class="modal-content">
            ...
            <form id="uploadForm">
                ...
                <div class="form-group">
                    <label>
                        <input type="checkbox" name="blockchain_verify" value="1" checked>
    ...
    <script>
        ...
        function verifyDocument(id) {
            fetch('<?php echo BASE_URL; ?>/api/verify-document.php', {
                method: 'POST',
