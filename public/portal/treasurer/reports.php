...
// Role check
$allowed_roles = ['treasurer', 'admin', 'super_admin'];
...
<div class="main-content">
    <div class="dashboard-header">
        <div class="header-content">
            <div>
                ...
                <p class="welcome-message">Generate and manage financial reports</p>
            </div>
        </div>
    </div>
    ...
    <div class="content-card">
        ...
        <p>Content will be available soon for financial reports management.</p>
