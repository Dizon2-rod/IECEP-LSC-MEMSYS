...
// Role check
$allowed_roles = ['secretary', 'admin', 'super_admin'];
    ...
    <div class="dashboard-header">
        <div class="header-content">
            <div>
                ...
                <p class="welcome-message">Manage meeting minutes and records</p>
            </div>
        </div>
    </div>

    <div class="content-card">
        <h2>Minutes Overview</h2>
        <p>Content will be available soon for meeting minutes management.</p>
