<?php
// sidebar_auditor.php - Auditor Sidebar Navigation
$user = get_user_info();
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        <ul class="nav-menu">
            <li>
                <a href="/IECEP-LSC-MEMSYS/public/portal/auditor/dashboard.php" 
            ...
            <li>
                <a href="/IECEP-LSC-MEMSYS/public/portal/auditor/verify-transactions.php" 
                   class="<?php echo $current_page === 'verify-transactions.php' ? 'active' : ''; ?>">
            ...
            <li>
                <a href="/IECEP-LSC-MEMSYS/public/portal/auditor/audit-logs.php" 
                   class="<?php echo $current_page === 'audit-logs.php' ? 'active' : ''; ?>">
        ...
        <div class="nav-section">
            ...
            <ul class="nav-menu">
                <li>
                    <a href="/IECEP-LSC-MEMSYS/public/portal/auditor/discrepancies.php" 
                       class="<?php echo $current_page === 'discrepancies.php' ? 'active' : ''; ?>">
                ...
                <li>
                    <a href="/IECEP-LSC-MEMSYS/public/portal/auditor/reports.php" 
