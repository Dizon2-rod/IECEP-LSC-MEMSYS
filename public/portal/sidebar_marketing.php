<?php
// sidebar_marketing.php - Marketing Committee Sidebar Navigation
$user = get_user_info();
...
<aside class="sidebar">
    <div class="sidebar-header">
        ...
        <div class="user-role-badge">
            <i class="fas fa-<?php echo $is_head ? 'crown' : 'shopping-cart'; ?>"></i>
    ...
    <nav class="sidebar-nav">
        <ul class="nav-menu">
            ...
            <li>
                <a href="/IECEP-LSC-MEMSYS/public/portal/marketing/merch.php" 
                   class="<?php echo $current_page === 'merch.php' ? 'active' : ''; ?>">
                    <i class="fas fa-tshirt"></i>
                    <span>Merchandise</span>
                </a>
            </li>
            <li>
                <a href="/IECEP-LSC-MEMSYS/public/portal/marketing/campaigns.php" 
            ...
            <li>
                <a href="/IECEP-LSC-MEMSYS/public/portal/marketing/sales.php" 
                   class="<?php echo $current_page === 'sales.php' ? 'active' : ''; ?>">
        ...
        <div class="nav-section">
            ...
            <ul class="nav-menu">
                <li>
                    <a href="/IECEP-LSC-MEMSYS/public/portal/marketing/team.php" 
                ...
                <li>
                    <a href="/IECEP-LSC-MEMSYS/public/portal/treasurer/dashboard.php" 
                       class="<?php echo strpos($_SERVER['REQUEST_URI'], 'treasurer') !== false ? 'active' : ''; ?>">
                        <i class="fas fa-coins"></i>
                        <span>Treasurer Office</span>
