            ...
            <div class="mt-2">
                ${paid
                    ? `<p><span class="badge badge-success">Paid</span></p>
                       ...
                       ${tx.blockchain_tx_hash ? `<p><span class="badge badge-onchain">On-Chain</span></p><p><a href="https://sepolia.etherscan.io/tx/${tx.blockchain_tx_hash}" target="_blank">View on Etherscan</a></p>` : ''}
