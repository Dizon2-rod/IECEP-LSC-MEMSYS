...
<head>
    ...
    <style>
        ...
        .announcement-header .badge.important {
            background: #f8d7da;
            color: #721c24;
        }
        
        .announcement-header .badge.event {
            background: #d4edda;
            color: #155724;
        }
        
        .announcement-header .badge.update {
            background: #d1ecf1;
            color: #0c5460;
        }
        
        .announcement-header .badge:not(.important):not(.event):not(.update) {
            background: #e9ecef;
            color: #495057;
        }
