...
try {
    ...
    error_log('Merch items exception: ' . $e->getMessage());
    $merchItems = [];
}
...
<!-- ═══════════════════════════════════════════════════════════ Merchandise Store -->
<section id="merchandise" class="section merch-store">
    <div class="container">
        <div class="section-heading text-center">
            <h2 class="section-title">IECEP‑LSC Merchandise</h2>
            <p class="section-subtitle">Support the chapter and look great with official IECEP-LSC merchandise. All proceeds go directly to chapter activities.</p>
        </div>
        ...
        <div id="merch-grid" class="merch-grid">
            <?php if (!empty($merchItems)): ?>
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <p style="grid-column:1/-1;text-align:center;color:#6b7280;padding:2rem">No merchandise available at this time.</p>
            <?php endif; ?>
        </div>
    </div>
</section>
...
@media (max-width: 480px) {
    ...
    .code-input { width: 32px; height: 32px; font-size: 0.875rem; }
        ...
        .merch-store .section-title { color: #0B1D4A; }
        .merch-store .section-subtitle { color: #64748b; max-width: 700px; margin: 0 auto; }
        .merch-grid {
            display: grid;
