...
-- Seed: Official fee brackets per Board Resolution No. 021-2024
...
VALUES 
    (UUID(), 'academic_year_start', '2026-06-01', 'Start date of academic year'),
    (UUID(), 'academic_year_end', '2027-05-31', 'End date of academic year'),
    (UUID(), 'compliance_participation_threshold', '40', 'Minimum participation percentage required'),
